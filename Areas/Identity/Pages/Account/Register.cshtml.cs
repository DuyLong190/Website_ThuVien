...
namespace QuanPhucLongQuang_DoAnWeb.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        {
            //Khai báo dữ liệu cho rolelist để đưa dữ liệu ra giao diện show
            if (!_roleManager.RoleExistsAsync(SD.Role_Customer).GetAwaiter().GetResult())
            {
                //Nếu trong db chưa khai báo role thì nó sẽ tiến hành insert vào DB
            ...
            //Tiến hành về danh sách role từ DB
            Input = new()
            {
            ...
            // Khởi tạo Input và RoleList để tránh null khi render view
